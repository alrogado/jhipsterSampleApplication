...
public class RegionResourceIntTest {
    ...
    private static final String DEFAULT_REGIONID = "AAAAAAAAAA";
    private static final String UPDATED_REGIONID = "BBBBBBBBBB";
    ...
    public void createRegion() throws Exception {
        ...
        assertThat(testRegion.getRegionid()).isEqualTo(DEFAULT_REGIONID);
    ...
    public void getAllRegions() throws Exception {
        ...
        restRegionMockMvc.perform(get("/api/regions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].regionid").value(hasItem(DEFAULT_REGIONID.toString())));
    }
    ...
    public void getRegion() throws Exception {
        ...
        restRegionMockMvc.perform(get("/api/regions/{id}", region.getId()))
            ...
            .andExpect(jsonPath("$.regionid").value(DEFAULT_REGIONID.toString()));
    }
    ...
    public void updateRegion() throws Exception {
        ...
        assertThat(testRegion.getRegionid()).isEqualTo(UPDATED_REGIONID);
